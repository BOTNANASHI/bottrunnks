...
const config = {
    A187: '📍𝐓𝐑𝐔𝐍𝐊𝐒📍',
    instagram: 'https://instagram.com/pesquisa_no_google_ofc?',
    nomer: 'wa.me/5562993745763',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UClUzL3qP1ggczYV1m65zoXg',
    whatsapp: 'https://chat.whatsapp.com/CjfY2nxGHFB3HKE15Igg14',
   ...
   switch (prefix) {
      ...
      case 'info':
       ...
       case 'nulis':
           nulis(value)
               .then(data => {
                   client.sendMessage(id, '[🐊⚡AGUARDE UM POUCO AI TO FAZENDO⚡🐊', MessageType.text)
   ...
   case 'bitly':
    ...
    case 'bucin':
     ...
     case 'cooltext':
           ...
           break
          case 'creator':
            client.sendContact(from, '62993745763@c.us')
            break
      case 'tts':
      ...
      case 'figugif':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    ...
                    client.reply(from, '[❗] KRLH E ASSIM-- *!stickerGif* max 10 sec!', id)
                )
            }
            break     
     case 'figu':
